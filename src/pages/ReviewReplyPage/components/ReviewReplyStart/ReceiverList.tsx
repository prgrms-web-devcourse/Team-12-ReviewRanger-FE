...
const ReceiverList = ({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-md border bg-white p-2 dark:border-gray-100 dark:bg-main-red-200">
      <div className="flex items-center justify-between px-2">
        ...
        <button
          type="button"
          className="rounded-md border border-gray-200 bg-main-hover-yellow px-2 py-1 text-xs dark:border-gray-100 dark:bg-main-gray dark:text-white md:text-sm"
      ...
      {receiverList.length > 0 && (
        <ul className="flex max-h-[200px] flex-col overflow-auto border bg-main-ivory">
          {receiverList.map((receiver, index) => (
            <li
              key={index}
              className="flex cursor-pointer items-center justify-between border-b border-gray-400 px-5 py-1.5 hover:bg-main-yellow dark:bg-main-gray dark:hover:bg-gray-300 md:px-5 md:py-2"
